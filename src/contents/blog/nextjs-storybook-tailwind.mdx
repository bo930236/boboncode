...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/nextjs-storybook-tailwind/button-storybook-preview_gibxko'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/nextjs-storybook-tailwind/vercel-deploy-config_gtv6ib'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/nextjs-storybook-tailwind/starter-features_zu6nfk'
  alt='starter-features'
  width={864}
  height={697}
/>

Check out the [ts-nextjs-tailwind-starter](https://github.com/boboncode/ts-nextjs-tailwind-starter)!
...
```bash
curl -s https://raw.githubusercontent.com/boboncode/expansion-pack/main/storybook/trigger.sh | bash -s
```

[Expansion pack repository](https://github.com/boboncode/expansion-pack#storybook)

### Plop Generator

The expansion pack is also equipped with a [plop](http://plopjs.com?ref=boboncode) generator to easily create a storybook file for your component
