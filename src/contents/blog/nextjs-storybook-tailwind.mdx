...
<CloudinaryImg
  mdx
  publicId='bobotsai/blogs/nextjs-storybook-tailwind/button-storybook-preview_gibxko'
...
<CloudinaryImg
  mdx
  publicId='bobotsai/blogs/nextjs-storybook-tailwind/vercel-deploy-config_gtv6ib'
...
<CloudinaryImg
  mdx
  publicId='bobotsai/blogs/nextjs-storybook-tailwind/starter-features_zu6nfk'
  alt='starter-features'
  width={864}
  height={697}
/>

Check out the [ts-nextjs-tailwind-starter](https://github.com/bobotsai/ts-nextjs-tailwind-starter)!
...
```bash
curl -s https://raw.githubusercontent.com/bobotsai/expansion-pack/main/storybook/trigger.sh | bash -s
```

[Expansion pack repository](https://github.com/bobotsai/expansion-pack#storybook)

### Plop Generator

The expansion pack is also equipped with a [plop](http://plopjs.com?ref=bobotsai) generator to easily create a storybook file for your component
