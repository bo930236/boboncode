...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/Next.js-Rendering-Pattern/e3c1bae9a50f0cf6a05be7661400d7deccf06dbb-1920x2200_in8ril'
...
- 這種渲染方式由單頁應用程序 (SPA) 使用，ex: React 和 Vue。
  ...
  <CloudinaryImg
    mdx
    publicId='boboncode/blogs/Next.js-Rendering-Pattern/3bc77dee2b8dd3dfb3a1bc5ca9e76702'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/Next.js-Rendering-Pattern/no-pre-rendering_bzscqb'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/Next.js-Rendering-Pattern/pre-rendering_wq0vtz'
  alt='pre-rendering'
  width={730}
  height={450}
/>
...
- SSR 伺服器端渲染是指每次瀏覽器發送請求時，伺服器才會產生 HTML 檔案然後丟回瀏覽器顯示。需要注意的是，這個渲染模式需要 server 一直處理使用者的請求。
  ...
  <CloudinaryImg
    mdx
    publicId='boboncode/blogs/Next.js-Rendering-Pattern/2089d151056f3030d102b2d1744c6bfe'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/Next.js-Rendering-Pattern/static-generation_ukasym'
...
<CloudinaryImg
  mdx
  publicId='boboncode/blogs/Next.js-Rendering-Pattern/mAbE8Bk_hlnsn7'
