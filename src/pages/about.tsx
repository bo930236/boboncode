...
export default function AboutPage() {
  ...
  return (
    <Layout>
      <Seo
        templateTitle='About'
        description='Bobo Tsai is a front-end developer that started learning in August 2022. She writes blogs about her approach on understanding topics in front-end development.'
      />
